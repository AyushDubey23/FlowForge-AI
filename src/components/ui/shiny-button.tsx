...
export const ShinyButton: React.FC<ShinyButtonProps> = ({
  ...
  return (
    <motion.button
      ...
      className={cn(
        "relative rounded-lg px-8 py-4 uppercase tracking-wide overflow-hidden font-open-sans-custom text-xs cursor-pointer select-none",
      ...
      {...props}
    >
      <span className="relative z-10 text-white font-bold drop-shadow-[0_2px_8px_rgba(0,0,0,0.8)]">
        {children}
      </span>
