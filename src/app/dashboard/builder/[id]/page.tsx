      ...
      <header className="flex h-14 items-center justify-between px-4 border-b border-border bg-card/45 backdrop-blur-md z-20 shrink-0 select-none">
        <div className="flex items-center gap-3 min-w-0">
          ...
          <Link href="/dashboard" className="hidden sm:flex items-center gap-2 shrink-0 group">
            <div className="relative flex h-7 w-7 shrink-0 items-center justify-center rounded-lg overflow-hidden border border-white/20 shadow-[0_0_12px_rgba(99,102,241,0.4)] group-hover:scale-105 transition-transform">
              <Image
                src="/icon.png"
                alt="FlowForge"
                width={28}
